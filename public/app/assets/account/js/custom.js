...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
    ...
    showSwalAccount: function(type, title, url=false){

        if(type == 'message-success-login'){

            swal({ title: 'Login efetuado com sucesso.',
        ...
        }else if(type == 'message-success-reset-password'){

            swal({ title: 'Senha alterada com sucesso.',
                text: "Por favor, faça login para entrar em sua conta!",
            ...
            swal({ title: title,
                text: "Fechando mensagem em 7 segundos.",
                timer: 7000,
                showConfirmButton: true
            });

        }else if(type == 'message-error-reset-password'){
    ...
    showSwal: function(type, url){
        ...
        }else if(type == 'redirect-login'){

        	swal({ title: "Login efetuado com Sucesso. ",
            	   text: "Redirecionando em 5 segundos.",
            	   timer: 5000,
            	   showConfirmButton: false
                });
