...
<head>
    ...
    <title>Home v1</title>
    <link rel='stylesheet' href='/app/vendor/store/supermarket/assets/css/bootstrap.min.css'>
    <link rel='stylesheet' href='/app/vendor/store/supermarket/assets/css/owl.carousel.min.css'>
    <link rel='stylesheet' href='/app/vendor/store/supermarket/assets/css/animated.css'>
    <link rel='stylesheet' href='/app/vendor/store/supermarket/assets/css/font-awesome.css'>
    <link rel='stylesheet' href='/app/vendor/store/supermarket/assets/css/ui.css'>
    <link rel='stylesheet' href='/app/vendor/store/supermarket/assets/css/jquery.mmenu.all.css'>
    <link rel='stylesheet' href='/app/vendor/store/supermarket/assets/css/flaticon.css'>
    <link rel='stylesheet' href='/app/vendor/store/supermarket/assets/css/style.css'>
...
<body>
                ...
                <div class="header-mid-right">
                    ...
                    <div class="header-mid-right-content country-select-menu">
                        <div class="country-select">
                            <div class="country select">
                                <img src="/app/vendor/store/supermarket/assets/images/flag.jpg" alt="flag" width="24" height="17">
                                English
                            </div>
                            <div class="country-dropdown">
                                <div class="country">
                                    <img src="/app/vendor/store/supermarket/assets/images/flag2.jpg" alt="flag" width="24" height="17">
                                    Hungary
                                </div>
                                <div class="country">
                                    <img src="/app/vendor/store/supermarket/assets/images/flag3.jpg" alt="flag" width="24" height="17">
                                    German
                                </div>
                                <div class="country">
                                    <img src="/app/vendor/store/supermarket/assets/images/flag4.jpg" alt="flag" width="24" height="17">
                                    French
                                </div>
                                <div class="country">
                                    <img src="/app/vendor/store/supermarket/assets/images/flag5.jpg" alt="flag" width="24" height="17">
                                    Canada
                                </div>
                                <div class="country">
                                    <img src="/app/vendor/store/supermarket/assets/images/flag6.jpg" alt="flag" width="24" height="17">
                                    Australia
                                </div>
                            </div>
        ...
        <div class="header-bottom">
            <div class="container">
                <div class="header-bottom-left">
                    <h1 class="logo">
                        <a href="index.html">
                            <img src="/app/vendor/store/supermarket/assets/images/logo.png" alt="logo">
                        </a>
                    </h1>
                            ...
                            <ul class="list-hover-cart">
                                <li class="hover-cart-item">
                                    <a href="#" class="img-hover-cart">
                                        <img src="/app/vendor/store/supermarket/assets/images/img-hover-cart.jpg" alt="img-hover-cart" width="75" height="89">
                                        ...
                                        <li class="menu-item has-mega">
                                            ...
                                            <div class="sub-menu mega-menu">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="img-mega">
                                                            <figure><img src="/app/vendor/store/supermarket/assets/images/mega.jpg" alt="mega" height="458" width="229"></figure>
                        ...
                        <div class="tab-pane active" id="1a">
                            <div class="featue-slide supermartket-owl-carousel" data-number="5" data-margin="30" data-navcontrol="yes" data-dots="yes">
                                <div class="product-list-content">
                                    <div class="product-item">
                                        <div class="product-media">
                                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/f1.jpg" alt="feature" width="200" height="238"></a></figure>
                                        </div>
                                ...
                                <div class="product-list-content">
                                    <div class="product-item">
                                        <div class="product-media">
                                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/f2.jpg" alt="feature" width="200" height="238"></a></figure>
                                        </div>
                                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                                        <p class="feature-slide-cost">From <span class="price">$168.00</span></p>
                                        <ul class="product-item-actions">
                                ...
                                <div class="product-list-content">
                                    <div class="product-item">
                                        <div class="product-media">
                                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/f3.jpg" alt="feature" width="200" height="238"></a></figure>
                                        </div>
                                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                                        <p class="feature-slide-cost">From <span class="price">$168.00</span></p>
                                        <ul class="product-item-actions">
                                ...
                                <div class="product-list-content">
                                    <div class="product-item">
                                        <div class="product-media">
                                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/f4.jpg" alt="feature" width="200" height="238"></a></figure>
                                        </div>
                                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                                        <p class="feature-slide-cost">From <span class="price">$168.00</span></p>
                                        <ul class="product-item-actions">
                                ...
                                <div class="product-list-content">
                                    <div class="product-item">
                                        <div class="product-media">
                                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/f5.jpg" alt="feature" width="200" height="238"></a></figure>
                                        </div>
                                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                                        <p class="feature-slide-cost">From <span class="price">$168.00</span></p>
                                        <ul class="product-item-actions">
                ...
                <div class="feature-products-category product-tabs">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="left-tab">
                                <figure>
                                    <img src="/app/vendor/store/supermarket/assets/images/smartphone.jpg" alt="smartphone" width="268" height="579">
                            ...
                            <div class="product-tabs-content tab-content clearfix">
                                <div class="tab-pane active" id="1b">
                                    ...
                                    <div class="slide-thumbs slide-bx">
                                        <div class="thumbs">
                                            <a data-slide-index="0" href=""><img src="/app/vendor/store/supermarket/assets/images/sm-small1.jpg" alt="sm-big"></a>
                                            <a data-slide-index="1" href=""><img src="/app/vendor/store/supermarket/assets/images/sm-small2.jpg" alt="sm-big"></a>
                                            <a data-slide-index="2" href=""><img src="/app/vendor/store/supermarket/assets/images/sm-small3.jpg" alt="sm-big"></a>
                                        </div>
                                        <div class="slide-container">
                                            <div><img src="/app/vendor/store/supermarket/assets/images/sm-big.jpg" alt="sm-big"></div>
                                            <div><img src="/app/vendor/store/supermarket/assets/images/sm-big.jpg" alt="sm-big"></div>
                                            <div><img src="/app/vendor/store/supermarket/assets/images/sm-big.jpg" alt="sm-big"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" id="2b">
                                    ...
                                    <div class="slide-thumbs slide-bx">
                                        <div class="thumbs">
                                            <a data-slide-index="0" href=""><img src="/app/vendor/store/supermarket/assets/images/sm-small2.jpg" alt="sm-big"></a>
                                            <a data-slide-index="1" href=""><img src="/app/vendor/store/supermarket/assets/images/sm-small2.jpg" alt="sm-big"></a>
                                            <a data-slide-index="2" href=""><img src="/app/vendor/store/supermarket/assets/images/sm-small3.jpg" alt="sm-big"></a>
                                        </div>
                                        <div class="slide-container">
                                            <img src="/app/vendor/store/supermarket/assets/images/sm-big.jpg" alt="sm-big">
                                            <img src="/app/vendor/store/supermarket/assets/images/sm-big.jpg" alt="sm-big">
                                            <img src="/app/vendor/store/supermarket/assets/images/sm-big.jpg" alt="sm-big">
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" id="3b">
                                    ...
                                    <div class="slide-thumbs slide-bx">
                                        <div class="thumbs">
                                            <a data-slide-index="0" href=""><img src="/app/vendor/store/supermarket/assets/images/sm-small2.jpg" alt="sm-big"></a>
                                            <a data-slide-index="1" href=""><img src="/app/vendor/store/supermarket/assets/images/sm-small3.jpg" alt="sm-big"></a>
                                            <a data-slide-index="2" href=""><img src="/app/vendor/store/supermarket/assets/images/sm-small3.jpg" alt="sm-big"></a>
                                        </div>
                                        <div class="slide-container">
                                            <img src="/app/vendor/store/supermarket/assets/images/sm-big.jpg" alt="sm-big">
        ...
        <section id="section3">
            <div class="container">
                ...
                <div class="product-list">
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/p1.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                    ...
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/p2.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                        <p class="feature-slide-cost"><span class="price">$168.00</span></p>
                        <ul class="product-item-actions">
                    ...
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/p3.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                        <p class="feature-slide-cost"><span class="price">$168.00</span></p>
                        <ul class="product-item-actions">
                    ...
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/p4.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                        <p class="feature-slide-cost"><span class="price">$168.00</span></p>
                        <ul class="product-item-actions">
                    ...
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/p5.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                        <p class="feature-slide-cost"><span class="price">$168.00</span></p>
                        <ul class="product-item-actions">
                ...
                <div class="row">
                    <div class="col-sm-6 padding-right5">
                        <div data-wow-delay="0.6s" class="banner-text wow zoomIn">
                            <figure><a href="#"><img alt="" src="/app/vendor/store/supermarket/assets/images/banner-text1.jpg"></a></figure>
                        </div>
                    </div>
                    <div class="col-sm-6 padding-left5">
                        <div data-wow-delay="0.6s" class="banner-text wow zoomIn">
                            <figure><a href="#"><img alt="" src="/app/vendor/store/supermarket/assets/images/banner-text2.jpg"></a></figure>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="feature-products-category product-tabs">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="left-tab">
                                <figure>
                                    <img src="/app/vendor/store/supermarket/assets/images/television.jpg" alt="television" width="268" height="579">
                                    <div class="left-tab-asblute">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="product-tabs-content tab-content clearfix">
                                <div class="tab-pane active" id="1c">
                                    ...
                                    <div class="slide-thumbs slide-bx">
                                        <div class="thumbs">
                                            <a data-slide-index="0" href=""><img src="/app/vendor/store/supermarket/assets/images/tv1.jpg" alt="sm-big"></a>
                                            <a data-slide-index="1" href=""><img src="/app/vendor/store/supermarket/assets/images/tv2.jpg" alt="sm-big"></a>
                                            <a data-slide-index="2" href=""><img src="/app/vendor/store/supermarket/assets/images/tv3.jpg" alt="sm-big"></a>
                                        </div>
                                        <div class="slide-container">
                                            <img src="/app/vendor/store/supermarket/assets/images/tv-big2.jpg" alt="sm-big">
                                            <img src="/app/vendor/store/supermarket/assets/images/tv-big2.jpg" alt="sm-big">
                                            <img src="/app/vendor/store/supermarket/assets/images/tv-big2.jpg" alt="sm-big">
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" id="2c">
                                    ...
                                    <div class="slide-thumbs slide-bx">
                                        <div class="thumbs">
                                            <a data-slide-index="0" href=""><img src="/app/vendor/store/supermarket/assets/images/tv2.jpg" alt="sm-big"></a>
                                            <a data-slide-index="1" href=""><img src="/app/vendor/store/supermarket/assets/images/tv1.jpg" alt="sm-big"></a>
                                            <a data-slide-index="2" href=""><img src="/app/vendor/store/supermarket/assets/images/tv3.jpg" alt="sm-big"></a>
                                        </div>
                                        <div class="slide-container">
                                            <img src="/app/vendor/store/supermarket/assets/images/tv-big2.jpg" alt="sm-big">
                                ...
                                <div class="tab-pane" id="3c">
                                    ...
                                    <div class="slide-thumbs slide-bx">
                                        <div class="thumbs">
                                            <a data-slide-index="0" href=""><img src="/app/vendor/store/supermarket/assets/images/tv3.jpg" alt="sm-big"></a>
                                            <a data-slide-index="1" href=""><img src="/app/vendor/store/supermarket/assets/images/tv2.jpg" alt="sm-big"></a>
                                            <a data-slide-index="2" href=""><img src="/app/vendor/store/supermarket/assets/images/tv1.jpg" alt="sm-big"></a>
                                        </div>
                                        <div class="slide-container">
                                            <img src="/app/vendor/store/supermarket/assets/images/tv-big2.jpg" alt="sm-big">
                                            <img src="/app/vendor/store/supermarket/assets/images/tv-big2.jpg" alt="sm-big">
                                ...
                                <div class="tab-pane" id="4c">
                                    ...
                                    <div class="slide-thumbs slide-bx">
                                        <div class="thumbs">
                                            <a data-slide-index="0" href=""><img src="/app/vendor/store/supermarket/assets/images/tv2.jpg" alt="sm-big"></a>
                                            <a data-slide-index="1" href=""><img src="/app/vendor/store/supermarket/assets/images/tv3.jpg" alt="sm-big"></a>
                                            <a data-slide-index="2" href=""><img src="/app/vendor/store/supermarket/assets/images/tv1.jpg" alt="sm-big"></a>
                                        </div>
                                        <div class="slide-container">
                                            <img src="/app/vendor/store/supermarket/assets/images/tv-big2.jpg" alt="sm-big">
        ...
        <section id="section6">
            <div class="container">
                ...
                <div class="product-list">
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/t1.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                        <p class="feature-slide-cost"><span class="price">$168.00</span></p>
                        <ul class="product-item-actions">
                    ...
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/t2.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                        <p class="feature-slide-cost"><span class="price">$168.00</span></p>
                        <ul class="product-item-actions">
                    ...
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/t3.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                        <p class="feature-slide-cost"><span class="price">$168.00</span></p>
                        <ul class="product-item-actions">
                    ...
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/t4.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                        <p class="feature-slide-cost"><span class="price">$168.00</span></p>
                        <ul class="product-item-actions">
                    ...
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/t5.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                        <p class="feature-slide-cost"><span class="price">$168.00</span></p>
                        <ul class="product-item-actions">
                ...
                <div class="product-list">
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/t6.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                        <p class="feature-slide-cost"><span class="price">$168.00</span></p>
                        <ul class="product-item-actions">
                    ...
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/t7.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                        <p class="feature-slide-cost"><span class="price">$168.00</span></p>
                        <ul class="product-item-actions">
                    ...
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/t8.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                        <p class="feature-slide-cost"><span class="price">$168.00</span></p>
                        <ul class="product-item-actions">
                    ...
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/t9.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                        <p class="feature-slide-cost"><span class="price">$168.00</span></p>
                        <ul class="product-item-actions">
                    ...
                    <div class="product-list-content">
                        <div class="product-media">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/t10.jpg" alt="feature" width="200" height="238"></a></figure>
                        </div>
                        <a href="#" class="feature-slide-name">Beatvs Solo2 On-Ear</a>
                        <p class="feature-slide-cost"><span class="price">$168.00</span></p>
                        <ul class="product-item-actions">
            ...
            <div class="container">
                ...
                <div class="brand-sale">
                    <div class="brand-sale-box row">
                        <div class="col-md-7">
                            <a href="#" class="brand-media"><img src="/app/vendor/store/supermarket/assets/images/sale1.jpg" alt="sale" width="649" height="269"></a>
                        </div>
                        <div class="col-md-5">
                            <div class="brand-sale-box-content">
                                <a href="#" class="brand-logo"><img src="/app/vendor/store/supermarket/assets/images/sale-logo1.jpg" alt="sale"></a>
                    ...
                    <div class="brand-sale-box row">
                        <div class="col-md-7">
                            <a href="#" class="brand-media"><img src="/app/vendor/store/supermarket/assets/images/sale2.jpg" alt="sale" width="649" height="269"></a>
                        </div>
                        <div class="col-md-5">
                            <div class="brand-sale-box-content">
                                <a href="#" class="brand-logo"><img src="/app/vendor/store/supermarket/assets/images/sale-logo2.jpg" alt="sale"></a>
                    ...
                    <div class="brand-sale-box row">
                        <div class="col-md-7">
                            <a href="#" class="brand-media"><img src="/app/vendor/store/supermarket/assets/images/sale3.jpg" alt="sale"></a>
                        </div>
                        <div class="col-md-5">
                            <div class="brand-sale-box-content">
                                <a href="#" class="brand-logo"><img src="/app/vendor/store/supermarket/assets/images/sale-logo3.jpg" alt="sale"></a>
                    ...
                    <div class="brand-sale-box row">
                        <div class="col-md-7">
                            <a href="#"><img src="/app/vendor/store/supermarket/assets/images/sale4.jpg" alt="sale" width="649" height="269"></a>
                        </div>
                        <div class="col-md-5">
                            <div class="brand-sale-box-content">
                                <a href="#" class="brand-logo"><img src="/app/vendor/store/supermarket/assets/images/sale-logo4.jpg" alt="sale"></a>
                ...
                <div class="row">
                    <div class="col-sm-6 padding-right5">
                        <div class="banner-text wow zoomIn" data-wow-delay="0.6s">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/banner-text.jpg" alt=""></a></figure>
                        </div>
                    </div>
                    <div class="col-sm-6 padding-left5">
                        <div class="banner-text wow zoomIn" data-wow-delay="0.6s">
                            <figure><a href="#"><img src="/app/vendor/store/supermarket/assets/images/banner-text3.jpg" alt=""></a></figure>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="section-logo-slide">
            <div class="container">
                <div class="logo-slide supermartket-owl-carousel" data-number="6" data-margin="30" data-navcontrol="yes">
                    <div class="logo-slide-item"><a href="#"><img src="/app/vendor/store/supermarket/assets/images/logo1.jpg" alt="logo" width="166" height="66"></a></div>
                    <div class="logo-slide-item"><a href="#"><img src="/app/vendor/store/supermarket/assets/images/logo2.jpg" alt="logo" width="166" height="66"></a></div>
                    <div class="logo-slide-item"><a href="#"><img src="/app/vendor/store/supermarket/assets/images/logo3.jpg" alt="logo" width="166" height="66"></a></div>
                    <div class="logo-slide-item"><a href="#"><img src="/app/vendor/store/supermarket/assets/images/logo4.jpg" alt="logo" width="166" height="66"></a></div>
                    <div class="logo-slide-item"><a href="#"><img src="/app/vendor/store/supermarket/assets/images/logo5.jpg" alt="logo" width="166" height="66"></a></div>
                    <div class="logo-slide-item"><a href="#"><img src="/app/vendor/store/supermarket/assets/images/logo6.jpg" alt="logo" width="166" height="66"></a></div>
                    <div class="logo-slide-item"><a href="#"><img src="/app/vendor/store/supermarket/assets/images/logo3.jpg" alt="logo" width="166" height="66"></a></div>
                    <div class="logo-slide-item"><a href="#"><img src="/app/vendor/store/supermarket/assets/images/logo2.jpg" alt="logo" width="166" height="66"></a></div>
                    <div class="logo-slide-item"><a href="#"><img src="/app/vendor/store/supermarket/assets/images/logo5.jpg" alt="logo" width="166" height="66"></a></div>
                </div>
        ...
        <div class="container">
            ...
            <div class="footer-mid">
                <div class="footer-mid-text">
                    <figure><img src="/app/vendor/store/supermarket/assets/images/check.jpg" alt="check" height="30" width="30"></figure>
                    <p>
                ...
                <!--<figure><img src="/app/vendor/store/supermarket/assets/images/img-logo-footer.jpg" alt="img-footer" height="60" width="1170"></figure>-->
                <ul>
                    <li><a href="#"><img src="/app/vendor/store/supermarket/assets/images/d1.jpg" alt="d" width="46" height="41"></a></li>
                    <li><a href="#"><img src="/app/vendor/store/supermarket/assets/images/d2.jpg" alt="d" width="51" height="41"></a></li>
                    <li><a href="#"><img src="/app/vendor/store/supermarket/assets/images/d3.jpg" alt="d" width="60" height="41"></a></li>
                    <li><a href="#"><img src="/app/vendor/store/supermarket/assets/images/d4.jpg" alt="d" width="44" height="41"></a></li>
                    <li><a href="#"><img src="/app/vendor/store/supermarket/assets/images/d5.jpg" alt="d" width="42" height="41"></a></li>
                    <li><a href="#"><img src="/app/vendor/store/supermarket/assets/images/d6.jpg" alt="d" width="85" height="41"></a></li>
                    <li><a href="#"><img src="/app/vendor/store/supermarket/assets/images/d7.jpg" alt="d" width="89" height="41"></a></li>
                    <li><a href="#"><img src="/app/vendor/store/supermarket/assets/images/d8.jpg" alt="d" width="92" height="41"></a></li>
                    <li><a href="#"><img src="/app/vendor/store/supermarket/assets/images/d9.jpg" alt="d" width="65" height="41"></a></li>
                    <li><a href="#"><img src="/app/vendor/store/supermarket/assets/images/d10.jpg" alt="d" width="91" height="41"></a></li>
                    <li><a href="#"><img src="/app/vendor/store/supermarket/assets/images/d11.jpg" alt="d" width="96" height="41"></a></li>
                    <li><a href="#"><img src="/app/vendor/store/supermarket/assets/images/d12.jpg" alt="d" width="64" height="41"></a></li>
                    <li><a href="#"><img src="/app/vendor/store/supermarket/assets/images/d13.jpg" alt="d" width="131" height="41"></a></li>
                    <li><a href="#"><img src="/app/vendor/store/supermarket/assets/images/d14.jpg" alt="d" width="94" height="41"></a></li>
                </ul>
            </div>
    ...
    <!--end footer-->
    <script type='text/javascript' src='/app/vendor/store/supermarket/assets/js/jquery.min.js'></script>
    <script type='text/javascript' src='/app/vendor/store/supermarket/assets/js/bootstrap.min.js'></script>
    <script type='text/javascript' src='/app/vendor/store/supermarket/assets/js/wow.min.js'></script>
    <script type='text/javascript' src='/app/vendor/store/supermarket/assets/js/owl.carousel.min.js'></script>
    <script type='text/javascript' src='/app/vendor/store/supermarket/assets/js/jquery.appear.min.js'></script>
    <script type='text/javascript' src='/app/vendor/store/supermarket/assets/js/jquery.countTo.js'></script>
    <script type='text/javascript' src='/app/vendor/store/supermarket/assets/js/ui.js'></script>
    <script type='text/javascript' src='/app/vendor/store/supermarket/assets/js/jquery.bxslider.min.js'></script>
    <script type='text/javascript' src='/app/vendor/store/supermarket/assets/js/jquery.mmenu.all.min.js'></script>
    <script type='text/javascript' src='/app/vendor/store/supermarket/assets/js/chosen.jquery.min.js'></script>
    <script type='text/javascript' src='/app/vendor/store/supermarket/assets/js/jquery.countdown.js'></script>
    <script type='text/javascript' src='/app/vendor/store/supermarket/assets/js/frontend.js'></script>
</body>
</html>