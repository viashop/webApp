...
<head>
    ...
    <!-- Favicons-->
    <link rel="shortcut icon" href="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/favicon.ico" type="image/x-icon">
    <link rel="apple-touch-icon" type="image/x-icon" href="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/apple-touch-icon-57x57-precomposed.png">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/apple-touch-icon-72x72-precomposed.png">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/apple-touch-icon-114x114-precomposed.png">
    <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/apple-touch-icon-144x144-precomposed.png">

    <!-- BASE CSS -->
    <link href="/app/vendor/homepage/citytours_3.0/html_v.3.0/css/base.css" rel="stylesheet">
   ...
   <link href='http://fonts.googleapis.com/css?family=Lato:300,400' rel='stylesheet' type='text/css'>
    ...
    <link href="/app/vendor/homepage/citytours_3.0/html_v.3.0/rs-plugin/css/settings.css" rel="stylesheet">
    <link href="/app/vendor/homepage/citytours_3.0/html_v.3.0/css/extralayers.css" rel="stylesheet">

    <!--[if lt IE 9]>
      <script src="/app/vendor/homepage/citytours_3.0/html_v.3.0/js/html5shiv.min.js"></script>
      <script src="/app/vendor/homepage/citytours_3.0/html_v.3.0/js/respond.min.js"></script>
    <![endif]-->
        ...
        <div class="container">
            <div class="row">
                ...
                <nav class="col-md-9 col-sm-9 col-xs-9">
                    ...
                    <div class="main-menu">
                        <div id="header_menu">
                            <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/logo_sticky.png" width="160" height="34" alt="City tours" data-retina="true">
                        </div>
                        ...
                        <li>
                            <div class="dropdown dropdown-cart">
                                ...
                                <ul class="dropdown-menu" id="cart_items">
                                    <li>
                                        <div class="image"><img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/thumb_cart_1.jpg" alt="image"></div>
                                        <strong>
                                        <a href="#">Louvre museum</a>1x $36.00 </strong>
                                        <a href="#" class="action"><i class="icon-trash"></i></a>
                                    </li>
                                    <li>
                                        <div class="image"><img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/thumb_cart_2.jpg" alt="image"></div>
                                        <strong>
                                        <a href="#">Versailles tour</a>2x $36.00 </strong>
                                        <a href="#" class="action"><i class="icon-trash"></i></a>
                                    </li>
                                    <li>
                                        <div class="image"><img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/thumb_cart_3.jpg" alt="image"></div>
                                        <strong>
        ...
        <div class="tp-banner">
            <ul>
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
                    <!-- MAIN IMAGE -->
                    <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/slides_bg/dummy.png" alt="slidebg1" data-lazyload="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/slides_bg/slide_1.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                    <!-- LAYER NR. 1 -->
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
                    <!-- MAIN IMAGE -->
                    <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/slides_bg/dummy.png" alt="slidebg1" data-lazyload="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/slides_bg/slide_4.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                    <!-- LAYER NR. 1 -->
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
                    <!-- MAIN IMAGE -->
                    <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/slides_bg/dummy.png" alt="slidebg1" data-lazyload="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/slides_bg/slide_6.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                    <!-- LAYER NR. 1 -->
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
                    <!-- MAIN IMAGE -->
                    <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/slides_bg/dummy.png" alt="slidebg1" data-lazyload="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/slides_bg/slide_5.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                    <!-- LAYER NR. 1 -->
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.1s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        ...
                        <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/tour_box_1.jpg" class="img-responsive" alt="image">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="single_tour.html">
                        <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/tour_box_2.jpg" width="800" height="533" class="img-responsive" alt="image">
                        <div class="short_info">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.3s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="single_tour.html">
                        <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/tour_box_3.jpg" width="800" height="533" class="img-responsive" alt="image">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="single_tour.html">
                        <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/tour_box_4.jpg" width="800" height="533" class="img-responsive" alt="image">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.5s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="single_tour.html">
                        <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/tour_box_14.jpg" width="800" height="533" class="img-responsive" alt="image">
                        <div class="short_info">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
                <div class="tour_container">
                    ...
                    <div class="img_container">
                        <a href="single_tour.html">
                        <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/tour_box_5.jpg" width="800" height="533" class="img-responsive" alt="image">
                        <div class="short_info">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.1s">
                    <div class="hotel_container">
                        ...
                        <div class="img_container">
                            ...
                            <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/hotel_1.jpg" width="800" height="533" class="img-responsive" alt="image">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                    <div class="hotel_container">
                        ...
                        <div class="img_container">
                            <a href="single_hotel.html">
                            <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/hotel_2.jpg"  width="800" height="533" class="img-responsive" alt="image">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="hotel_container">
                        ...
                        <div class="img_container">
                            <a href="single_hotel.html">
                            <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/hotel_3.jpg"  width="800" height="533" class="img-responsive" alt="image">
           ...
           <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                    <div class="hotel_container">
                        ...
                        <div class="img_container">
                            <a href="single_hotel.html">
                            <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/hotel_4.jpg" width="800" height="533" class="img-responsive" alt="image">
                            <div class="score"><span>7.5</span>Good</div>
                            <div class="short_info hotel">
                                    From/Per night<span class="price"><sup>$</sup>45</span>
                            </div>
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.5s">
                    <div class="hotel_container">
                        ...
                        <div class="img_container">
                            <a href="single_hotel.html">
                            <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/hotel_5.jpg"  width="800" height="533" class="img-responsive" alt="image">
            ...
            <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
                    <div class="hotel_container">
                        ...
                        <div class="img_container">
                            <a href="single_hotel.html">
                            <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/hotel_6.jpg" width="800" height="533" class="img-responsive" alt="image">
        ...
        <div class="container margin_60">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/bus.jpg" alt="Pic" class="img-responsive"></a>
                    </p>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/transfer.jpg" alt="Pic" class="img-responsive"></a>
                    </p>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/guide.jpg" alt="Pic" class="img-responsive"></a>
                    </p>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <p>
                        <a href="#"><img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/hotel.jpg" alt="Pic" class="img-responsive"></a>
                    </p>
    ...
    <div class="container margin_60">
        ...
        <div class="row">
            <div class="col-md-8 col-sm-6 hidden-xs">
                <img src="/app/vendor/homepage/citytours_3.0/html_v.3.0/img/laptop.png" alt="Laptop" class="img-responsive laptop">
            </div>
...
<div id="toTop"></div><!-- Back to top button -->
    ...
    <!-- Common scripts -->
    <script src="/app/vendor/homepage/citytours_3.0/html_v.3.0/js/jquery-1.11.2.min.js"></script>
    <script src="/app/vendor/homepage/citytours_3.0/html_v.3.0/js/common_scripts_min.js"></script>
    <script src="/app/vendor/homepage/citytours_3.0/html_v.3.0/js/functions.js"></script>

    <!-- SLIDER REVOLUTION 4.x SCRIPTS  -->
    <script src="/app/vendor/homepage/citytours_3.0/html_v.3.0/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
    <script src="/app/vendor/homepage/citytours_3.0/html_v.3.0/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
    <script src="/app/vendor/homepage/citytours_3.0/html_v.3.0/js/revolution_func.js"></script>
