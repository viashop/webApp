...
@section('form-search')
    {!! Form::open(['url' => route('theme::users.admin.read'), 'method' => 'get', 'class' => 'navbar-form navbar-left navbar-search-form', 'role' => 'search'] ) !!}
            ...
            <div class="card">
                <div class="header">
                    ...
                    <div class="col-xs-6 text-right">
                        ...
                        <a href="{{ route('theme::users.admin.create') }}" class="btn btn-default btn-fill btn-wd"
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td class="td-actions text-right">
                                    ...
                                    <a href="{{ route('theme::users.admin.update', $user->id) }}" rel="tooltip"
                                    ...
                                    <a href="javascript://"
                                       onclick="custom.showSwalUser('password-message-confirmation', '{{ route('theme::users.admin.new.password', $user->id) }}', '{{ $user->email }}')"
                                       rel="tooltip" title="Gerar nova senha" class="btn btn-warning btn-simple btn-xs">
                                        <i class="fa fa-envelope-square fa-2x"></i>
                                    </a>

                                    <a href="javascript://"
                                       onclick="custom.showSwalUser('delete-message-confirmation', '{{ route('theme::users.admin.delete', $user->id) }}', '{{ $user->name }}')"
