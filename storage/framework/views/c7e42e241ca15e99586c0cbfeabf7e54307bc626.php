...
<head lang="en">
    ...
    <![endif]-->
<link rel="stylesheet" href="/app/vendor/dashboard/build/css/lib/lobipanel/lobipanel.min.css">
<link rel="stylesheet" href="/app/vendor/dashboard/build/css/separate/vendor/lobipanel.min.css">
<link rel="stylesheet" href="/app/vendor/dashboard/build/css/lib/jqueryui/jquery-ui.min.css">
<link rel="stylesheet" href="/app/vendor/dashboard/build/css/separate/pages/widgets.min.css">
...
<body class="with-side-menu theme-side-ebony-clay">
    ...
    <header class="site-header">
        <div class="container-fluid">
            <a href="#" class="site-logo">
                <img class="hidden-md-down" src="/app/vendor/dashboard/build/img/logo-2-white.png" alt="">
                <img class="hidden-lg-up" src="/app/vendor/dashboard/build/img/logo-2-mob.png" alt="">
            </a>
                    ...
                    <div class="site-header-shown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-notif" aria-labelledby="dd-notification">
                                ...
                                <div class="dropdown-menu-notif-list">
                                    <div class="dropdown-menu-notif-item">
                                        <div class="photo">
                                            <img src="/app/vendor/dashboard/build/img/photo-64-1.jpg" alt="">
                                        </div>
                                        <div class="dot"></div>
                                    ...
                                    <div class="dropdown-menu-notif-item">
                                        <div class="photo">
                                            <img src="/app/vendor/dashboard/build/img/photo-64-2.jpg" alt="">
                                        </div>
                                        <div class="dot"></div>
                                    ...
                                    <div class="dropdown-menu-notif-item">
                                        <div class="photo">
                                            <img src="/app/vendor/dashboard/build/img/photo-64-3.jpg" alt="">
                                        </div>
                                        <div class="dot"></div>
                                    ...
                                    <div class="dropdown-menu-notif-item">
                                        <div class="photo">
                                            <img src="/app/vendor/dashboard/build/img/photo-64-4.jpg" alt="">
                                        </div>
                                    ...
                                    <div class="tab-pane active" id="tab-incoming" role="tabpanel">
                                        <div class="dropdown-menu-messages-list">
                                            <a href="#" class="mess-item">
                                                <span class="avatar-preview avatar-preview-32"><img src="/app/vendor/dashboard/build/img/photo-64-2.jpg" alt=""></span>
                                                <span class="mess-item-name">Tim Collins</span>
                                                <span class="mess-item-txt">Morgan was bothering about something!</span>
                                            </a>
                                            <a href="#" class="mess-item">
                                                <span class="avatar-preview avatar-preview-32"><img src="/app/vendor/dashboard/build/img/avatar-2-64.png" alt=""></span>
                        ...
                        <div class="dropdown user-menu">
                            <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="/app/vendor/dashboard/build/img/avatar-2-64.png" alt="">
                            </button>
    ...
    <script type="text/javascript" src="/app/vendor/dashboard/build/js/lib/jqueryui/jquery-ui.min.js"></script>
    <script type="text/javascript" src="/app/vendor/dashboard/build/js/lib/lobipanel/lobipanel.min.js"></script>
