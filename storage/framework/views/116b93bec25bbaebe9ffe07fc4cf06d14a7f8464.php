...
<link rel="stylesheet" href="/app/vendor/dashboard/build/css/separate/vendor/jquery-steps.min.css">
...
<body class="with-side-menu">
    ...
    <script src="/app/vendor/dashboard/build/js/lib/jquery-validation/jquery.validate.min.js"></script>
    <script src="/app/vendor/dashboard/build/js/lib/jquery-steps/jquery.steps.min.js"></script>
    <script>
        $(function() {
            $("#example-basic ").steps({
                headerTag: "h3",
